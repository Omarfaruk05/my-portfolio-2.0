            ...
            <Cart path="/contact">
              ...
              <div>
                <div className="flex justify-between">
                  ...
                  <button className="bg-white text-black rounded-md p-1 font-bold">
                    $599
                  </button>
                </div>
                <p className="my-6 text-sm text-gray-400">
                  String Properties and Method Normally strings like cannot have
                  methods or properties because they ar
                </p>
              </div>
            </Cart>
          </SlideIn>
